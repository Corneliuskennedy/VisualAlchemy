...
const OurWorkPage: React.FC = () => {
  ...
  const breadcrumbItems = [
    ...
    },
    {
      ...
      titleNL: 'Ons Werk',
      href: isNL ? '/nl/our-work' : '/our-work',
      isCurrent: true
    }
  ];
  ...
  return (
    <>
      <UnifiedSEO 
        title={isNL ? "Ons Werk & Case Studies | Octomatic AI Automatisering" : "Our Work & Case Studies | Octomatic AI Automation"}
        ...
        canonicalUrl={isNL ? "https://www.octomatic.ai/nl/our-work" : "https://www.octomatic.ai/our-work"}
